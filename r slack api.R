...
# Token for GE slack
###############################################################################
incoming_webhook_url <- "https://hooks.slack.com/services/XXXXXX/XXXX/XXXXXXXXXXXXXXXXXX"
...
#--------------------------------Detailed-Message------------------------------
slack.detailed.message <- function(target,pretext,title,title.link,text,subtitle,subcontent,imageurl,footer,footericon,color,author){
